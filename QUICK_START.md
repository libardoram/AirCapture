...
### For Long Sessions:
- Use **low frame rates** (0.2-1 fps) to save space
- Default 0.2 fps (every 5 seconds) ≈ ~2.4 MB per minute per stream
...
| 0.5 fps | ~6 MB/min | Long sessions (4+ hours) |
...
**That's it! You're ready to use AirCapture. Enjoy!** 
