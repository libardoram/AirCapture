...
**A:** Settings → General → Number of Streams → Set to desired number (1-100) → Restart app. For many streams, use a Mac with sufficient RAM and a wired Ethernet connection.
