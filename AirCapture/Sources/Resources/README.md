...
### Core Capabilities
-  **Multiple Simultaneous Streams** - Support for 1-100 concurrent AirPlay connections (use a Mac with sufficient RAM and wired Ethernet for best performance with many streams)
...
### General
- **Number of Streams**: 1-100 concurrent connections (default: 4). For best performance with many streams, use a Mac with sufficient RAM and a wired Ethernet connection.
