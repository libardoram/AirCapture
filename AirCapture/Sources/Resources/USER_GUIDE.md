...
### Key Features
- **Multiple Concurrent Streams**: Support for 1-100 simultaneous AirPlay connections (use a Mac with sufficient RAM and wired Ethernet for best performance with many streams)
...
- **Adaptive Layout**: Automatically adjusts columns based on stream count
  ...
  - 26-40 streams: 6 columns
  - 41-60 streams: 8 columns
  - 61-100 streams: 10 columns
...
**Video Playback**
- Videos play back at the same frame rate they were captured
- 1 fps = 1 frame per second playback
- 30 fps = smooth real-time playback
...
- Named with timestamp: `StreamName_YYYY-MM-DD_HH-MM-SS.mp4`
- H.264 encoded with configurable quality

**Consolidated Video**
- Final merged video: `StreamName_CONSOLIDATED.mp4`
- Combines all segments chronologically
- Created when recording stops
- Intermediate segments deleted after consolidation
...
- For many streams, use a Mac with sufficient RAM and a wired Ethernet connection

 **DON'T:**
- Try to run too many streams on limited hardware
