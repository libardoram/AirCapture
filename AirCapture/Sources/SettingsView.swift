    ...
    private var generalSettings: some View {
        VStack(alignment: .leading, spacing: 24) {
            SettingRow(
                ...
                description: "Configure how many student devices can connect simultaneously. Changes require restarting the receivers."
            ) {
                HStack {
                    Stepper("\(settings.streamCount)", value: $settings.streamCount, in: 1...30)
                        .frame(width: 120)
